...
interface TradeFormComplianceChecklistProps {
...
export function TradeFormComplianceChecklist({
  strategyId,
  onComplianceChange,
  initialCompliance,
}: TradeFormComplianceChecklistProps) {
  ...
  useEffect(() => {
    ...
    fetchRules()
  }, [strategyId, supabase, toast, initialCompliance])
  ...
  useEffect(() => {
    ...
    const followedRules = Object.values(compliance).filter(Boolean).length
    const score = Math.round((followedRules / rules.length) * 100)
  ...
  if (!strategyId) {
    return (
      <div className="flex flex-col items-center justify-center p-6 text-center border border-dashed rounded-lg border-border/50">
        ...
        <p className="text-muted-foreground">Select a strategy to view compliance checklist</p>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">Check the rules you followed in this trade</p>
      </div>
        ...
        <div key={category} className="space-y-3">
          ...
          <div className="space-y-3">
            {categoryRules.map((rule) => (
              <div key={rule.id} className="p-3 rounded-lg bg-background/50 border border-border/50">
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1.5 flex-1">
                    ...
                    {!compliance[rule.id] && (
                      <Textarea
                        placeholder={`Why didn't you follow this rule?`}
      ...
      <div className="space-y-2">
        ...
        <Textarea
          id="compliance-notes"
          placeholder="Add any general notes about your strategy compliance..."
